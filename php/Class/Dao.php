...
class Dao {
    ...
    public static function getPDO() {
        try {
            ...
            exit("<b>ERREUR :</b> dans la conexion avec la DB"); // Stopper l'execution de programme est afficher le message celle dans exit function
        }
    }
    ...
    // pour recupérer ga3 data li kayn f table farray soit ta3 admin soit ta3 client soit fournisseur
