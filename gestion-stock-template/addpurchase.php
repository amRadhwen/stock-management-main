                ...
                <table class="table">
                  <thead>
                    <tr>
                      ...
                      <th class="text-end">Unit Cost(DT)</th>
                      <th class="text-end">Total Cost (DT)</th>
                      <th></th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?= $item['prix_achat'] ?>DT</td>
                      <td class="text-end"><?= $item['prix_uni'] ?>DT</td>
                      <td class="text-end"><?= $item['qte_achete'] * $item['prix_achat'] ?>DT</td>
                      <td>
