                            ...
                            <div class="dash-widget">
                                ...
                                <div class="dash-widgetcontent">
                                    <h5><span class="counters"
                                            data-count="<?= $total_all_pur ?>"><?= $total_all_pur ?>DT</span></h5>
                                    <h6>Total Purchases (DT)</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="dash-widget dash1">
                                ...
                                <div class="dash-widgetcontent">
                                    <h5><span class="counters"
                                            data-count="<?= $total_all_sales ?>"><?= $total_all_sales ?>DT</span></h5>
                                    <h6>Total Sales (DT)</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="dash-widget dash2">
                                ...
                                <div class="dash-widgetcontent">
                                    <h5><span class="counters"
                                            data-count="<?= $total_all_sales - $total_all_pur ?>"><?= $total_all_sales - $total_all_pur ?>DT</span>
                                    </h5>
                                    <h6>Total Profit (DT)</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6 col-12">
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Customer</th>
                                            <th>Date</th>
                                            <th>Grand Total (DT)</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php if (count($all_sales)){
                                            for ($i = 0; $i <= 3; $i++): ?>
                                                <tr>
                                                    ...
                                                    <td class="productimgname">
                                                        ...
                                                        <a
                                                            href="javascript:void(0);"><?= $all_sales[$i]['nom'] . " " . $all_sales[$i]['prenom'] ?></a>
                                                    </td>
                                                    <td><?= $all_sales[$i]['date_com'] ?></td>
                                                    <td><?= $all_sales[$i]['total'] ?></td>
                                                </tr>
                                            <?php endfor;}else {?><tr><td colspan="4" style="text-align:center;">No data available in table</td></tr><?php } ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive dataview">
                                <table class="table datatable ">
                                    ...
                                    <tbody>
                                        <?php if(count($almost_expired_products)){for ($i = 0; $i < 4; $i++): ?>
                                            <tr>
                                                <td><?= $i + 1; ?></td>
                                                <td class="productimgname">
